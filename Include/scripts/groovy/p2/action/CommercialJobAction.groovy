...
public class CommercialJobAction extends P2Base{
	...
	/*	  public void JobcategoryBettermentsSpanReplacementInputs(RemoteWebDriver driver) {
	 ...
	 driver.findElement(By.cssSelector(JobcategoryInputParameters.getjobtype_SpanReplacement())).click();
	 ActionUtils.waitFor3Seconds();
	 driver.findElements(By.cssSelector(JobcategoryInputParameters.getcategory_select())).get(2).click();
	 ActionUtils.waitFor1Seconds();
	 driver.findElement(By.cssSelector(JobcategoryInputParameters.getsubtype_SpanReplacement_HFC())).click();
	 ActionUtils.waitFor3Seconds();
	 driver.findElement(By.xpath(JobcategoryInputParameters.getnext_categorybutton())).click();
	 }*/
	...
	public void provideJobDetails(RemoteWebDriver driver,String subtype) throws AWTException {
		...
		ActionUtils.waitFor1Seconds();
		driver.findElement(By.cssSelector(JobcategoryInputParameters.getinitiatedBy())).sendKeys(JobcategoryInputParameters.getintiatedby_value());
		ActionUtils.waitFor1Seconds();
		driver.findElement(By.cssSelector(JobcategoryInputParameters.getinitiatedByEmail())).click();
		ActionUtils.waitFor1Seconds();
		driver.findElement(By.cssSelector(JobcategoryInputParameters.getinitiatedByEmail())).sendKeys(JobcategoryInputParameters.getintiatedbyid_value());
		ActionUtils.waitFor1Seconds();
		...
		ActionUtils.waitFor1Seconds();
		driver.findElement(By.cssSelector(JobcategoryInputParameters.getcustomername())).sendKeys(JobcategoryInputParameters.getCustomernamevalue());
		ActionUtils.waitFor1Seconds();
		driver.findElement(By.cssSelector(JobcategoryInputParameters.getsitedevelopmentpropname())).click();
		ActionUtils.waitFor1Seconds();
		driver.findElement(By.cssSelector(JobcategoryInputParameters.getsitedevelopmentpropname())).sendKeys(JobcategoryInputParameters.getSite_Development_value());
		ActionUtils.waitFor1Seconds();
		...
		ActionUtils.waitFor1Seconds();
		driver.findElement(By.cssSelector(JobcategoryInputParameters.getlocalcontactname())).sendKeys(JobcategoryInputParameters.getcustomer_Contact_value());
		ActionUtils.waitFor1Seconds();

		/*driver.findElement(By.cssSelector(JobcategoryInputParameters.getlocalcontactemail())).click();
		 ActionUtils.waitFor1Seconds();
		 driver.findElement(By.cssSelector(JobcategoryInputParameters.getlocalcontactemail())).sendKeys(JobcategoryInputParameters.getcustomer_contact_email_value());
		 ActionUtils.waitFor2Seconds();*/
		...
		ActionUtils.waitFor1Seconds();
		driver.findElements(By.cssSelector(JobcategoryInputParameters.getneedByField())).get(1).sendKeys(CommonUtils.endDate());
		ActionUtils.waitFor1Seconds();
		...
		WebElement element1 = driver.findElements(By.cssSelector(JobcategoryInputParameters.gettotalPrePostCalcJobFlow())).get(20);
		...
		driver.findElements(By.cssSelector(JobcategoryInputParameters.gettotalPrePostCalcJobFlow())).get(20).sendKeys(JobcategoryInputParameters.gettotalPrePostCalcJobFlow_value1());
		ActionUtils.waitFor1Seconds();
		driver.findElements(By.cssSelector(JobcategoryInputParameters.gettotalPrePostCalcJobFlow())).get(21).sendKeys(JobcategoryInputParameters.gettotalPrePostCalcJobFlow_value2());
		ActionUtils.waitFor1Seconds();
		driver.findElements(By.cssSelector(JobcategoryInputParameters.gettotalPrePostCalcJobFlow())).get(22).sendKeys(JobcategoryInputParameters.gettotalPrePostCalcJobFlow_value3());
		ActionUtils.waitFor2Seconds();
		...
		.isDisplayed()) {
			...
			.isDisplayed()) {
				logger.info("Owner loaded in the details page"
						+ driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidateReadOnlyJobFields())).get(0)
						.isDisplayed());
				...
				.getAttribute("innerText").contains(CommonUtils.endDate())) {
					...
					if (driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidateReadOnlyJobFields())).get(2)
					.getAttribute("innerText").contains(JobcategoryInputParameters.getUnfunded_Text())) {
						logger.info("Funding Request Status in the details page"
						...
						.get(4).getAttribute("innerText").contains(JobcategoryInputParameters.getDescription_check())) {
							...
							if (driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields()))
							.get(7).getAttribute("innerText").contains(JobcategoryInputParameters.getcommentsField_value())) {
								logger.info("comments loaded in the details page" + driver
										.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields()))
										.get(7).getAttribute("innerText"));
								if (driver
								.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields()))
								.get(8).getAttribute("innerText").contains(JobcategoryInputParameters.getcifawarehouse_value())) {
									...
									.findElements(
									By.cssSelector(JobcategoryInputParameters.getvalidatejobfields()))
									.get(9).getAttribute("innerText").contains(JobcategoryInputParameters.getlaborZone())) {
						...
						logger.info("Funding Request Status  Not in the details page"
								+ driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidateReadOnlyJobFields()))
								.get(2).isDisplayed());
						flag = false;
	...
	public boolean verifyclassificationBettermentsSubtype(RemoteWebDriver driver) {
		...
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields())).get(4).getAttribute("innerText"));

		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields())).get(7).getAttribute("innerText"));
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields())).get(8).getAttribute("innerText"));
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields())).get(9).getAttribute("innerText"));
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields())).get(49).getAttribute("innerText"));
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields())).get(51).getAttribute("innerText"));
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields())).get(52).getAttribute("innerText"));
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields())).get(53).getAttribute("innerText"));
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields())).get(54).getAttribute("innerText"));
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields())).get(55).getAttribute("innerText"));
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields())).get(56).getAttribute("innerText"));


		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields())).get(57).getAttribute("innerText"));

		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidateReadOnlyJobFields())).get(0).getAttribute("innerText")+" dummy");

		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidateReadOnlyJobFields())).get(37).getAttribute("innerText"));
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidateReadOnlyJobFields())).get(35).getAttribute("innerText"));
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidateReadOnlyJobFields())).get(36).getAttribute("innerText"));
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidateReadOnlyJobFields())).get(38).getAttribute("innerText"));
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidateReadOnlyJobFields())).get(39).getAttribute("innerText") +" dummy");
		boolean main=false;
		if (driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidateReadOnlyJobFields())).get(36).getAttribute("innerText").equals("Betterments")) {
			logger.info("Job category in the details page"
					+ driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidateReadOnlyJobFields())).get(36)
							...
							.get(70).isDisplayed()) {
								...
								.get(71).isDisplayed()) {
									...
									.get(38).isDisplayed()) {
										...
										logger.info("Default Spa in the details page" + driver.findElements(
												By.cssSelector(JobcategoryInputParameters.getvalidateReadOnlyJobFields()))
												.get(38).isDisplayed());
										if (driver
										.findElements(
										By.cssSelector(JobcategoryInputParameters.getvalidatejobfields()))
	...
	public boolean verifyclassificationBettermentsWithoutSubtype(RemoteWebDriver driver) {
		...
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields())).get(68).getAttribute("innerText"));
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields())).get(69).getAttribute("innerText"));
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields())).get(70).getAttribute("innerText"));
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields())).get(71).getAttribute("innerText"));
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields())).get(72).getAttribute("innerText"));
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields())).get(73).getAttribute("innerText"));
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields())).get(74).getAttribute("innerText"));
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidateReadOnlyJobFields())).get(0).getAttribute("innerText")+" dummy");
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidateReadOnlyJobFields())).get(38).getAttribute("innerText"));
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidateReadOnlyJobFields())).get(37).getAttribute("innerText"));
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidateReadOnlyJobFields())).get(36).getAttribute("innerText"));
	...
	public boolean verifyHighlightPanel(RemoteWebDriver driver) {
		...
		System.out.println(driver.findElements(By.cssSelector("div[class='slds-form-element__static slds-truncate']")).get(1).getText());
		System.out.println(driver.findElements(By.cssSelector("div[class='slds-form-element__static slds-truncate']")).get(2).getText());
		System.out.println(driver.findElements(By.cssSelector("div[class='slds-form-element__static slds-truncate']")).get(3).getText());
		System.out.println(driver.findElements(By.cssSelector("div[class='slds-form-element__static slds-truncate']")).get(4).getText());
		System.out.println(driver.findElements(By.cssSelector("div[class='slds-form-element__static slds-truncate']")).get(5).getText());


		if (driver.findElements(By.cssSelector(JobcategoryInputParameters.getverifyHighlightPanelFieldTextArea())).get(0)
		.isDisplayed()) {
			if (driver.findElements(By.cssSelector(JobcategoryInputParameters.getverifyHighlightPanelFieldTextArea())).get(1).getText().contains(JobcategoryInputParameters.getUnfunded())) {
				if (driver.findElements(By.cssSelector(JobcategoryInputParameters.getverifyHighlightPanelFieldTextArea())).get(2).getText().contains(JobcategoryInputParameters.getOpened()))
				{
					...
					.isDisplayed()) {
						...
						.get(1).isDisplayed()) {
							...
							logger.info("Description Not loaded  in the Job page" + driver.findElements(By.cssSelector(JobcategoryInputParameters.getverifyHighlightPanelText()))
									.get(1).isDisplayed());
							flag = false;
						}
					} else {
						logger.info("Job ID Not loaded  in the Job page" +driver.findElements(By.cssSelector(JobcategoryInputParameters.getverifyHighlightPanelText()))
								.get(0).isDisplayed());
						flag = false;
					}

				} else {
					logger.info("Status Not loaded  in the Job page"
							+ driver.findElements(By.cssSelector(JobcategoryInputParameters.getverifyHighlightPanelFieldTextArea()))
							.get(2).isDisplayed());
					flag = false;

				}
			} else {
				logger.info("Funding Status Not loaded  in the Job page" + driver.findElements(By.cssSelector(JobcategoryInputParameters.getverifyHighlightPanelFieldTextArea()))
						.get(1).isDisplayed());
				flag = false;
			}
	...
	public static TestStepStatus jobActionButtonValidation(RemoteWebDriver driver) {
		...
		.equals(JobcategoryInputParameters.getEdit())) {
			...
			.equals(JobcategoryInputParameters.getChangeDate())) {
				if (driver.findElement(By.cssSelector(JobcategoryInputParameters.getMaterials_compactlayot()))
				.getText().equals(JobcategoryInputParameters.getAddMaterials())) {
	...
	public boolean verifyQuickActionButtons(RemoteWebDriver driver) {
		...
		.isDisplayed()) {
			System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getquickActionbuttons())).get(0)
					.getAttribute("innerText"));
			System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getquickActionbuttons())).get(1)
					.getAttribute("innerText"));
			System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getquickActionbuttons())).get(2)
					.getAttribute("innerText"));
			System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getquickActionbuttons())).get(3)
					.getAttribute("innerText"));
			System.out.println(driver.findElement(By.cssSelector(JobcategoryInputParameters.getapprovebutton())).getText());
			System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getnotRequiredButton())).get(0)
					.getAttribute("innerText"));
				...
				.isDisplayed()) {
					...
					.isDisplayed()) {
						...
						.get(3).isDisplayed()) {
							...
							.isDisplayed()) {
								ActionUtils.waitFor1Seconds();
								if (driver.findElements(By.cssSelector(JobcategoryInputParameters.getnotRequiredButton())).get(0).isDisplayed()) {
									flag = true;
								} else {
	...
	public boolean verifyValuesInJobDetails(RemoteWebDriver driver) {
		...
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields())).get(17).getText());
		System.out.println(driver.findElements(By.cssSelector(JobcategoryInputParameters.getvalidatejobfields())).get(18).getText());
		return flag;
