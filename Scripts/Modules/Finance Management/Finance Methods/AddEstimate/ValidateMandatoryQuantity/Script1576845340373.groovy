...
WebUI.sendKeys(findTestObject('Finance/FullFlowLabor/Page_AddLabor Salesforce/InputLaborCode'), 'u10')
...
WebUI.verifyElementText(findTestObject('Finance/ErrorMsgLabor/Page_JB0000151607  Salesforce/div_ErrorBusiness Partner and Labor Code are required fields'), 'Quantity is required field.')
