...
WebUI.verifyElementText(findTestObject('Finance/ErrorMsgLabor/Page_JB0000151607  Salesforce/div_ErrorBusiness Partner and Labor Code are required fields'), 'Business Partner and Labor Code are required fields.')
