...
WebUI.focus(findTestObject('Finance/FullFlowLabor/ApproveEstimate/ButtonAction/button_Approve'))
...
WebUI.click(findTestObject('Finance/FullFlowLabor/ApproveEstimate/ButtonAction/button_Approve'))
