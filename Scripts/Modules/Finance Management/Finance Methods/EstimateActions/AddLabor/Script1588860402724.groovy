...
WebUI.sendKeys(findTestObject('Object Repository/Finance/Labor creation/LaborCodeInput'), LaborName.toString())

WebUI.sendKeys(findTestObject('Object Repository/Finance/Labor creation/LaborCodeDescription'), LaborName.toString())
