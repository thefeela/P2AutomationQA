...
WebUI.Click(findTestObject('Object Repository/ReservationButtons/CloseReservation'))
...
WebUI.verifyElementPresent(findTestObject('Labor headers/Estimates'), 10)

WebUI.verifyElementPresent(findTestObject('Labor headers/Description'), 10)
