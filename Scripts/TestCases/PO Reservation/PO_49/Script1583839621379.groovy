...
WebElement[] contentsPOFund = driver.findElements(findTestObject('Object Repository/ReservePO/FinalReserveButtonwithPO')) as WebElement[]
...
for (int r = 0; r < rowsCount; r++) {
		String ContentString=""
			...
			if(ContentString=='Oracle Project Name:' ){}
			else if(ContentString=='Oracle Project Number:' ){}
			else if (ContentString=='PO Expenditure Type:'){}
			else if( ContentString=='ORACLE PO Total Amount'){}
			else if( ContentString=='Current P2 PO Reservations:'){}
			else if (ContentString=='Selected Total:'){}
			else if( ContentString=='P2 PO Remaining Balance'){}
