...
WebUI.callTestCase(findTestCase('CommonMethods/Login - BP'), [:], FailureHandling.STOP_ON_FAILURE)
String StrUrl=  WebUI.getUrl().toString();
//WebUI.callTestCase(findTestCase('CommonMethods/CreateXNETJob'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementNotPresent(findTestObject('ReservationButtons/ReservePO'), 10)
