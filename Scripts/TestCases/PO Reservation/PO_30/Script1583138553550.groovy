...
WebUI.verifyElementText(findTestObject('Object Repository/ReservePO/ReservePO_Headers/ReservePOHeaders')[2],'Line Item Description')

WebUI.verifyElementText(findTestObject('Object Repository/ReservePO/ReservePO_Headers/ReservePOHeaders')[3],'Oracle Project Name')

WebUI.verifyElementText(findTestObject('Object Repository/ReservePO/ReservePO_Headers/ReservePOHeaders')[4],'Business Partner Name')

WebUI.verifyElementText(findTestObject('Object Repository/ReservePO/ReservePO_Headers/ReservePOHeaders')[5],'Oracle Project Number')

WebUI.verifyElementText(findTestObject('Object Repository/ReservePO/ReservePO_Headers/ReservePOHeaders')[6],'PO Expenditure Type')
