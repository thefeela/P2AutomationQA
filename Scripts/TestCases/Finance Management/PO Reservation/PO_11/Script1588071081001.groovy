...
List<WebElement> rowsInTable = driver.findElements(By.xpath("//table[contains(@class,'slds-table slds-table_fixed-layout slds-table_bordered slds-table_header-fixed')]/tbody/tr  |   //div[contains(@class,\'slds-scrollable_y')]/table/tbody/tr"))
