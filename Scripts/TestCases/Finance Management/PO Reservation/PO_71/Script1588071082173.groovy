...
GlobalVariable.ORAPO_OracleAmt=50

WebUI.callTestCase(findTestCase('Modules/Finance Management/Finance Methods/EstimateActions/EditORAPO'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementAttributeValue(imgInGrid[c],'alt','Red',10)
