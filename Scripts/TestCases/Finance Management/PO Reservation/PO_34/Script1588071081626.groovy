...
//WebUI.verifyElementText(findTestObject('Finance/ORAPOs/ReservePO/ItemDescription'), '')
...
WebUI.click(findTestObject('Finance/ORAPOs/Page_2409818  Salesforce/lightning-formatted-text_OPEN'))
