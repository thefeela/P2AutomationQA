...
WebUI.sendkeys(findTestObject('Finance/ORAPOs/EditPOStatusInput'), 'Canceled W/ Reservations Canceled')
...
WebUI.delay(2)
WebUI.verifyElementVisible(findTestObject('Finance/ErrorMsgLabor/Page_JB0000151607  Salesforce/div_ErrorBusiness Partner and Labor Code are required fields'))