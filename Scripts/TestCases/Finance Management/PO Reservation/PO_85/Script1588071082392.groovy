...
WebElement[] ORAPOGrid = driver.findElements(findTestObject('Finance/ORAPOs/OraPONoLine in ORAList')) as WebElement[]
...
WebUI.delay(2)
WebUI.verifyElementAttributeValue(findTestObject('Finance/ORAPO Creation/Page_New ORA_PO  Salesforce/input_Oracle PO Total Amount_832774a'),'title',GlobalVariable.ORAPO_OracleAmt,10)
