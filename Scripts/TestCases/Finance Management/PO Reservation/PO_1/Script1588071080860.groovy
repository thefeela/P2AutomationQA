...
WebUI.verifyElementPresent(findTestObject('Finance/ReservationButtons/ReservePO'), 10)

WebUI.verifyElementPresent(findTestObject('Finance/ReservationButtons/UndoReservation'), 10)

WebUI.verifyElementPresent(findTestObject('Finance/ReservationButtons/CloseReservation'), 10)
WebUI.verifyElementPresent(findTestObject('Finance/ReservationButtons/Re-price'),10)
// ADD reprice button
